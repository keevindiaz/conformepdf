...
# Verificar si wkhtmltopdf es ejecutable y dar permisos si no los tiene
if not os.access(WKHTMLTOPDF_PATH, os.X_OK):
    try:
        os.chmod(WKHTMLTOPDF_PATH, 0o755)  # Dar permisos de ejecución
    except Exception as e:
        raise RuntimeError(f"No se pudieron asignar permisos de ejecución a wkhtmltopdf: {e}")
